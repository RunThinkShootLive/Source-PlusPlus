...
public:
	...
	constexpr CViewVectors(
		const Vector& vView,
		const Vector& vHullMin,
		const Vector& vHullMax,
		const Vector& vDuckHullMin,
		const Vector& vDuckHullMax,
		const Vector& vDuckView,
		const Vector& vObsHullMin,
		const Vector& vObsHullMax,
		const Vector& vDeadViewHeight ) :	m_vView(vView), m_vHullMin( vHullMin ), m_vHullMax( vHullMax ),
											m_vDuckHullMin( vDuckHullMin ), m_vDuckHullMax( vDuckHullMax ), m_vDuckView( vDuckView ),
											m_vObsHullMin( vObsHullMin ), m_vObsHullMax( vObsHullMax ), m_vDeadViewHeight( vDeadViewHeight )
	{}
...
#ifdef RTSL
#define RTSL_GravityGunFreezeColor Color(246, 219, 50)
#define RTSL_SuperGravityGunFreezeColor Color(162, 243, 237)
#endif
